    ...
    <>
        ...
        <div className="page-shell grid min-h-[calc(100dvh-76px)] items-center gap-10 py-16 md:grid-cols-[1.08fr_.92fr] md:py-20">
          <div className="reveal relative z-10">
            ...
            <h1 className="mt-6 max-w-3xl font-display text-[clamp(42px,6vw,78px)] font-normal leading-[.92] tracking-[-.02em] text-[#321e2a]">
              29 Flavours.<br />
              <span className="italic font-normal text-[#d84f78]">Endless</span><br />
              Possibilities.
            </h1>
      ...
      <section className="bg-[#cfe7dc]">
        <div className="page-shell py-20 md:py-28">
          ...
          <div className="mt-12 text-center">
            <Link href="/products" className="ink-button inline-flex items-center gap-3 px-6 py-4 text-[11px] font-semibold uppercase tracking-[.16em]" data-testid="link-home-catalogue">
      ...
      <section className="page-shell grid gap-10 py-20 md:grid-cols-[1fr_1fr] md:py-28">
        <div className="relative min-h-[360px] overflow-hidden bg-[#e8a1ba] p-8 md:min-h-[480px]">
          ...
          <p className="relative z-10 text-[9rem] leading-[.7] text-[#fff3f8] font-display font-normal md:text-[14rem]">29</p>
          <p className="absolute bottom-8 left-8 max-w-[180px] text-[10px] font-semibold uppercase leading-5 tracking-[.14em] text-[#6d2d45]">29 exceptional flavours for craft beverage menus</p>
        </div>
        <div className="flex flex-col justify-center">
          ...
          <h2 className="mt-4 font-display text-[clamp(36px,5vw,64px)] font-normal leading-[.90] text-[#321e2a]">
            Bold taste.<br /><span className="italic text-[#d84f78]">Unmissable pour.</span>
          </h2>
          <p className="mt-6 max-w-md text-[15px] leading-[1.65] text-[#684454]">
            Flamingo is anchored to the world of drinks: the anticipation before the pour, the shape of a glass, the pause before the first sip.
          </p>
          <Link href="/about" className="mt-8 inline-flex w-fit items-center gap-3 border-b border-[#321e2a] pb-2 text-[11px] font-semibold uppercase tracking-[.16em]" data-testid="link-home-about">
      ...
      <section className="border-y border-rose-300/70 bg-[#f9d7e4]">
        <div className="page-shell flex flex-col items-start justify-between gap-8 py-16 md:flex-row md:items-center md:py-20">
          ...
          <Link href="/enquire" className="ink-button inline-flex items-center gap-3 px-6 py-4 text-[11px] font-semibold uppercase tracking-[.16em]" data-testid="link-home-enquire">
