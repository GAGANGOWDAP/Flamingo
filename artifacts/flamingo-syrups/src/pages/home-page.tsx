...
export function HomePage() {
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden">
        <div className="page-shell grid min-h-[calc(100dvh-76px)] items-center gap-10 py-16 md:grid-cols-[1.08fr_.92fr] md:py-20">
          <div className="reveal relative z-10">
            ...
            {/* HERO HEADING - REFINED ELEGANT CORMORANT GARAMOND */}
            <h1 className="mt-6 max-w-3xl font-display text-[clamp(42px,6vw,78px)] font-normal leading-[.92] tracking-[-.02em] text-[#321e2a]">
              29 Flavours.
              <br />
              <span className="italic font-normal text-[#d84f78]">Endless</span>
              <br />
              Possibilities.
            </h1>

            {/* HERO SUPPORTING COPY - REFINED INTER 400 */}
            <p className="mt-7 max-w-[480px] font-sans text-[15px] md:text-[17px] font-normal leading-[1.62] text-[#684454]">
              A premium syrup range crafted for mixologists, beverage managers,
              and craft bars. Explore our complete 29 flavour collection
              available in 750 ml professional packs.
            </p>

            <div className="mt-9 flex flex-wrap items-center gap-5">
              <Link
                href="/products"
                className="ink-button inline-flex items-center gap-3 px-6 py-4 font-sans text-[11.5px] font-semibold uppercase tracking-[.16em] transition-transform hover:-translate-y-0.5 shadow-sm"
              ...
              <Link
                href="/about"
                className="group inline-flex items-center gap-2 font-sans text-[12.5px] font-medium tracking-[.04em] text-[#593b49] transition-colors hover:text-[#d84f78]"
          ...
          <div className="reveal reveal-delay-2 relative flex min-h-[420px] items-center justify-center md:min-h-[580px]">
            ...
            <div className="relative rounded-[50%_50%_44%_56%] bg-[#f7c4d6] p-4 shadow-[0_25px_70px_rgba(153,63,98,.16)] md:p-7">
              <div className="rounded-[50%_50%_44%_56%] border border-[#fff3f8]/70 bg-[#fbd6e4] p-8 md:p-12">
                <img
                  src={logoPath}
                  alt="Flamingo logo: a pink flamingo in a cocktail glass with the FLAMINGO wordmark"
                  className="relative z-10 h-56 w-56 object-contain md:h-72 md:w-72"
                />
              </div>
            </div>
            <span className="absolute bottom-[7%] right-[2%] rotate-[-8deg] font-display text-3xl italic text-[#b63d65] md:text-5xl">
              made to be noticed
            </span>
          </div>
        </div>
        ...
        <div className="page-shell flex items-center justify-between pb-8 text-[.65rem] font-bold uppercase tracking-[.18em] text-[#996074]">
          ...
          <span className="flex items-center gap-3">
            Scroll to explore <ArrowDown size={14} className="pulse-line" />
          </span>
        </div>
      </section>
      ...
      {/* THE CRAFT SECTION */}
      <section className="page-shell grid gap-12 py-20 md:grid-cols-[.75fr_1.25fr] md:py-28">
        <div>
          ...
          <h2 className="mt-4 font-display text-[clamp(34px,4.5vw,56px)] font-normal leading-[.95] text-[#321e2a]">
            Real ingredients.
            <br />
            <span className="italic text-[#d84f78]">Vibrant pour.</span>
          </h2>
        </div>
        <div className="grid gap-8 md:grid-cols-2 md:pt-6">
          <p className="font-sans text-[15px] md:text-[16px] font-normal leading-[1.65] text-[#684454]">
            Flamingo syrups bring balance, theatrical colour, and rich flavour
            depth to every drink. From traditional Indian Jamun and Guava Chilli
            to European Limoncello, Blue Curaçao, and Pandan leaf.
          </p>
          <div className="border-l-2 border-[#d84f78] pl-6">
            <p className="font-display text-2xl md:text-3xl italic font-normal leading-tight text-[#b63d65]">
              “One syrup. Endless possibilities for every craft bar.”
            </p>
            <p className="mt-4 text-[10px] font-semibold uppercase tracking-[.16em] text-[#996074]">
              29 Exceptional Flavours · 750 ml
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="relative overflow-hidden border-t border-b border-[#ebd7df]/70 bg-[#fdfbf7] py-20 md:py-28">
        <div className="page-shell max-w-4xl mx-auto">
          ...
          <div className="reveal">
            ...
            <p className="mt-7 font-display text-xl md:text-2xl italic font-normal text-[#b63d65] leading-[1.38] border-l-2 border-[#d84f78]/60 pl-5 py-0.5 max-w-2xl">
              Flamingo Flavours was born from a simple idea — to share the delight of exceptional flavours with everyone.
            </p>

            {/* BODY PARAGRAPHS */}
            <div className="mt-7 space-y-4 font-sans text-[15px] md:text-[16px] font-normal leading-[1.68] text-[#593b49] max-w-2xl">
              <p>
            ...
            {/* FINISHING LINE */}
            <div className="mt-10 pt-6 border-t border-[#ebd7df]/60 max-w-2xl">
      ...
      <section className="bg-[#cfe7dc]">
        <div className="page-shell py-20 md:py-28">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <h2 className="mt-4 font-display text-[clamp(34px,4.5vw,56px)] font-normal leading-[.92] text-[#234039]">
              Designed for perfection in every drop.
            </h2>
          </div>
          <motion.div
            ...
            {[
              {
                ...
                desc: "Real taste extracted from authentic fruits, herbs & botanicals.",
              },
              {
                title: "Vibrant Colours",
                desc: "Bright, appealing and consistent hue for dramatic cocktails.",
              },
              {
                title: "Consistent Quality",
                desc: "Same great taste and balance in every 750 ml bottle.",
              },
              {
                title: "Versatile Applications",
                desc: "Perfect for mocktails, cocktails, spritzes, and iced teas.",
              },
              {
                title: "Professional Pack",
                desc: "Available in standard 750 ml bar bottle format.",
              },
            ].map((feature, index) => (
              <motion.div
                key={feature.title}
              ...
              >
                ...
                <div className="relative z-10">
                  <span className="inline-block font-display text-2xl font-normal text-[#b63d65] transition-transform duration-500 group-hover:scale-110 group-hover:rotate-3">
                    0{index + 1}
                  </span>
                  <h3 className="mt-3 font-display text-xl font-medium text-[#234039] transition-colors duration-300 group-hover:text-[#d84f78]">
                    {feature.title}
                  </h3>
                  <p className="mt-2 text-xs leading-5 text-[#3d6155]">
                    {feature.desc}
                  </p>
                </div>
              </motion.div>
      ...
      {/* EDITORIAL MIXOLOGIST COLLECTION */}
      <section className="page-shell grid gap-10 py-20 md:grid-cols-[1fr_1fr] md:py-28">
        <div className="relative min-h-[360px] overflow-hidden bg-[#e8a1ba] p-8 md:min-h-[480px]">
          ...
          <p className="relative z-10 text-[9rem] leading-[.7] text-[#fff3f8] font-display font-normal md:text-[14rem]">
            29
          </p>
          <p className="absolute bottom-8 left-8 max-w-[180px] text-[10px] font-semibold uppercase leading-5 tracking-[.14em] text-[#6d2d45]">
            29 exceptional flavours for craft beverage menus
          </p>
        </div>
        <div className="flex flex-col justify-center">
          <SectionKicker>A Mixologist's Collection</SectionKicker>
          <h2 className="mt-4 font-display text-[clamp(36px,5vw,64px)] font-normal leading-[.90] text-[#321e2a]">
            Bold taste.
            <br />
            <span className="italic text-[#d84f78]">Unmissable pour.</span>
          </h2>
          <p className="mt-6 max-w-md text-[15px] leading-[1.65] text-[#684454]">
            Flamingo is anchored to the world of drinks: the anticipation before
            the pour, the shape of a glass, the pause before the first sip.
          </p>
          <Link
            href="/about"
            className="mt-8 inline-flex w-fit items-center gap-3 border-b border-[#321e2a] pb-2 text-[11px] font-semibold uppercase tracking-[.16em]"
      ...
      <section className="border-y border-rose-300/70 bg-[#f9d7e4]">
        <div className="page-shell flex flex-col items-start justify-between gap-8 py-16 md:flex-row md:items-center md:py-20">
          <div>
            ...
            <h2 className="mt-3 max-w-2xl font-display text-[clamp(34px,4.5vw,56px)] font-normal leading-[.92]">
