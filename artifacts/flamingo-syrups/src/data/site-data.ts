...
export const syrupsList: SyrupItem[] = [
  ...
  },
  {
    ...
    pairingNotes: 'Dry gin, sparkling wine, lemonade, Earl Grey iced teas, and botanical sours.',
    volume: '750 ml',
  ...
  },
  {
    ...
    pairingNotes: 'Prosecco, gin tonics, cucumber spritzes, and sparkling mineral water.',
    volume: '750 ml',
    tag: 'Alpine Blossom',
    tone: 'petal',
    badgeColor: '#059669',
    ...
    recipe: {
      ...
      method: 'Build syrup and muddled mint over ice in a wine glass. Top with Prosecco and soda, stir gently.',
  ...
  },
  {
    ...
    pairingNotes: 'Gin, white rum, iced milk teas, sparkling lemonades, and floral spritzes.',
    volume: '750 ml',
    tag: 'Aromatic Petal',
    tone: 'rose',
    badgeColor: '#e11d48',
  ...
  },
  {
    ...
    pairingNotes: 'Aged rum, spiced tequila, tropical punches, and coconut water highballs.',
    volume: '750 ml',
    tag: 'Exotic Nectar',
    tone: 'gold',
    badgeColor: '#d97706',
  ...
  },
  {
    ...
    pairingNotes: 'Bourbon, rye whiskey, aged rum, dark spirit sours, and artisanal sodas.',
    volume: '750 ml',
    tag: 'Rich Dark Fruit',
    tone: 'amber',
    badgeColor: '#78350f',
  ...
  },
  {
    ...
    pairingNotes: 'White rum, blanco tequila, sparkling sodas, iced teas, and green mocktails.',
    volume: '750 ml',
    tag: 'Garden Mint',
    tone: 'mint',
    badgeColor: '#10b981',
    ...
    recipe: {
      ...
      method: 'Build rum, syrup and lime juice over ice. Top with soda and stir gently.',
  ...
  },
  {
    ...
    pairingNotes: 'Espresso, cold brew, dark rum, bourbon sours, and steamed lattes.',
    volume: '750 ml',
    tag: 'Vanilla Bean',
    tone: 'amber',
    badgeColor: '#b45309',
    ...
    recipe: {
      ...
      method: 'Shake hard with ice and fine strain into a chilled martini glass.',
  ...
  },
  {
    ...
    pairingNotes: 'Vodka, white rum, prosecco floats, Tiki cocktails, and tropical lemonades.',
    volume: '750 ml',
    tag: 'Tart & Tropical',
    tone: 'gold',
    badgeColor: '#ca8a04',
    ...
    recipe: {
      ...
      method: 'Shake vodka, syrup and lime juice with ice. Strain into a chilled coupe and serve with a Prosecco shot on the side.',
